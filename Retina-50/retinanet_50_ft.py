...
# Paths
train_img_folder = "/home/anjali/Documents/Anjali/openDET2/datasets/VisDrone_dataset/train"
train_ann_file = "/home/anjali/Documents/Anjali/train_coco.json"

val_img_folder = "/home/anjali/Documents/Anjali/openDET2/datasets/VisDrone_dataset/val"
val_ann_file = "/home/anjali/Documents/Anjali/val_coco.json"
...
with open("Log_file_LPFT_ACLS.txt", 'a+') as lpft_log:
    for epoch in range(num_epochs_ft):
        ...
        with torch.no_grad():
            ...
            if results["map_50"] > mAP_LPFT_best:
                mAP_LPFT_best = results["map_50"]
                torch.save(model_ft.state_dict(), f"/home/anjali/Documents/Anjali/RetinaNet_torch/checkpoints_ACLS_mAP/best_LPFT_model_epoch_{epoch+1}.pth")
    ...
    torch.save(model_ft.state_dict(), "/home/anjali/Documents/Anjali/RetinaNet_torch/checkpoints_ACLS_mAP/retinanet_ACLS_LPFT.pth")
